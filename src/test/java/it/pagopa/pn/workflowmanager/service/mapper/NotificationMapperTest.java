        ...
        InformalSentNotificationV1 informal = new InformalSentNotificationV1()
                ...
                .recipients(Collections.singletonList(
                        new FullInformalNotificationRecipientV1()
                                ...
                                .message(new NewMessageRequest()
                                        .primaryMessage(new NewMessageRequestPrimaryMessage()
                                                .subject("Subject message")
                                                .language("IT")
                                                .longBody("long body test")
                                                .shortBody("short body test")
                                        )
                                        .additionalMessage(new NewMessageRequestAdditionalMessage()
                                                .subject("Subject additional message")
                                                .language("EN")
                                                .longBody("long body test additional")
                                                .shortBody("short body test additional")
                                        )
                                )
                                .digitalDomicile(
