...
class EventRouterTest {
    ...
    private void inspectErrorCode(PnEventRouterException exception) {
        Assertions.assertEquals(it.pagopa.pn.workflowmanager.exceptions.WorkflowManagerExceptionCodes.ERROR_CODE_DELIVERYPUSH_ROUTER_EVENT_TYPE_MISSING, exception.getProblem().getErrors().getFirst().getCode());
    }
