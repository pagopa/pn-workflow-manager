...
public class EventHandlerRegistry {
    ...
    private void registerHandler(EventHandler<?> handler) {
        ...
        if(Objects.isNull(handler.getSupportedEventType())) {
            ...
            throw new PnEventRouterException(errorMessage, ERROR_CODE_WORKFLOWMANAGER_ROUTER_INVALID_SUPPORTED_EVENT);
        }
        ...
        if (handlerRegistry.containsKey(handler.getSupportedEventType().name())) {
            ...
            throw new PnEventRouterException(errorMessage, ERROR_CODE_WORKFLOWMANAGER_ROUTER_MULTIPLE_HANDLERS_FOUND);
        }
