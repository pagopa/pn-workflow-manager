...
public class WorkflowUtils {
    // TODO: scommentare quando disponibile private final SchedulerService schedulerService;

    public void scheduleTimeoutForCurrentChannel(Campaign campaign, ChannelType channel) {
        ...
        if (timeout.isPresent()) {
            ...
            // TODO: aggiungere logica per schedulare azione di timeout
        } else {
    ...
    private WorkFlowEntity getWorkflowEntityForCurrentChannel(Campaign campaign, ChannelType channel) {
        ...
        return campaign.getWorkflow().stream()
                ...
                .findFirst()
                .orElseThrow(() -> new PnWorkflowException("No workflow entity found for channel: " + channel));
    }
}
