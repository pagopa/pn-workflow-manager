...
public class AddressSearchUtils {
    ...
    public void storeSearchOutcome(
        ...
        TimelineElementInternal timelineElement = timelineUtils.buildAvailabilitySourceTimelineElement(ctx.recipientIndex(), ctx.notification(), outcome.source(), outcome.found(), ctx.attempt(), outcome.address(), outcome.tosAccepted());
