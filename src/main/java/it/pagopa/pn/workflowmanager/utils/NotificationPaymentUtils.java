...
public class NotificationPaymentUtils {
    public static PagoPaInt getPagoPaPaymentFromNoticeCode(NotificationInt notification, int recIndex, String noticeCode) {
        ...
        return recipient.getPayments().stream()
                ...
                .map(NotificationPaymentInfoInt::getPagoPA)
                .findFirst()
